...
# Tabela Users
users: Dict[int, User] = {
    1: User(id=1, name="Jan Kowalski", email="jan@example.com", level=15, reputation="Zaufany Pasażer"),  # Zaufany Pasażer
    2: User(id=2, name="Anna Nowak", email="anna@example.com", level=8, reputation="Nowicjusz Podróżnik"),    # Nowicjusz Podróżnik
    3: User(id=3, name="Piotr Wiśniewski", email="piotr@example.com", level=0, reputation="Anonimowy"),  # Anonimowy
    4: User(id=4, name="Maria Kowalczyk", email="maria@example.com", level=25, reputation="Ekspert Tras"),  # Ekspert Tras
    5: User(id=5, name="Tomasz Lewandowski", email="tomasz@example.com", level=-3, reputation="Podejrzany"),  # Podejrzany
    6: User(id=6, name="Katarzyna Zielińska", email="kasia@example.com", level=50, reputation="Mistrz Komunikacji"),  # Mistrz Komunikacji
    7: User(id=7, name="Michał Dąbrowski", email="michal@example.com", level=120, reputation="Legenda Transportu"),  # Legenda Transportu
    8: User(id=8, name="Agnieszka Wójcik", email="aga@example.com", level=250, reputation="Guru Podróży"),  # Guru Podróży
    9: User(id=9, name="Robert Kamiński", email="robert@example.com", level=600, reputation="Czarodziej Infrastruktury"),  # Czarodziej Infrastruktury
    10: User(id=10, name="Magdalena Krawczyk", email="magda@example.com", level=-15, reputation="Niewiarygodny Reporter"),  # Niewiarygodny Reporter
    11: User(id=11, name="Paweł Szymański", email="pawel@example.com", level=-30, reputation="Czarna Lista"),  # Czarna Lista
    12: User(id=12, name="Joanna Woźniak", email="joanna@example.com", level=3, reputation="Nowicjusz Podróżnik"),   # Nowicjusz Podróżnik
}
